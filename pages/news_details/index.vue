<template>
	<view class='page' :data-theme="theme">
		...
		<home></home>
		<view>
			<comment-eg :commentObj="{'objId':id,'objType':'news'}" :visit="articleInfo.visit"></comment-eg>
		</view>
	</view>
</template>
...
<script>
	...
	import commentEg from '@/components/comment-eg/comment-eg.vue'
	export default {
		components: {
			shareInfo,
			home,
			"jyf-parser": parser,
			'comment-eg': commentEg,
		},
		data() {
			return {
				id: 0,
