	...
	export default {
		...
		data() {
			return {
				...
				imgHost:'',
				backBg:'attachimage/change/bargain_header/bargain_header1.jpg',
				navBgColor:'#e93323'
			};
		},
		...
		onLoad: function(options) {
			...
			switch (app.globalData.theme) {
				case 'theme1':
					that.backBg = 'attachimage/change/bargain_header/bargain_header1.jpg';
					that.bgColor.bgColor = '#e93323';
					that.navBgColor = '#e93323';
					break;
				case 'theme2':
					that.backBg = 'attachimage/change/bargain_header/bargain_header2.jpg';
					that.bgColor.bgColor = '#FE5C2D';
					that.navBgColor = '#FE5C2D';
					break;
				case 'theme3':
					that.backBg = 'attachimage/change/bargain_header/bargain_header3.jpg';
					that.bgColor.bgColor = '#42CA4D';
					that.navBgColor = '#42CA4D';
					break;
				case 'theme4':
					that.backBg = 'attachimage/change/bargain_header/bargain_header4.jpg';
					that.bgColor.bgColor = '#1DB0FC';
					that.navBgColor = '#1DB0FC';
					break;
				case 'theme5':
					that.backBg = 'attachimage/change/bargain_header/bargain_header5.jpg';
