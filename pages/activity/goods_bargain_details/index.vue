	...
	export default {
		...
		data() {
			return {
				...
				imgHost:'',
				backBg:'attachimage/change/bargain_header_bg/bargain_header_bg1.jpg',
				backHead:'attachimage/change/bargain_tip/bargain_tip1.png'
			}
		...
		onLoad: function(options) {
			...
			switch (that.theme) {
				case 'theme1':
					that.backBg = 'attachimage/change/bargain_header_bg/bargain_header_bg1.jpg';
					that.backHead = 'attachimage/change/bargain_tip/bargain_tip1.png';
					that.posterbackgd = '../../../static/images/bargain_post1.png' // 因为跨域不能使用网络图片，
					break;
				case 'theme2':
					that.backBg = 'attachimage/change/bargain_header_bg/bargain_header_bg2.jpg';
					that.backHead = 'attachimage/change/bargain_tip/bargain_tip2.png';
					that.posterbackgd = '../../../static/images/bargain_post2.png'
					break;
				case 'theme3':
					that.backBg = 'attachimage/change/bargain_header_bg/bargain_header_bg3.jpg';
					that.backHead = 'attachimage/change/bargain_tip/bargain_tip3.png';
					that.posterbackgd = '../../../static/images/bargain_post3.png'
					break;
				case 'theme4':
					that.backBg = 'attachimage/change/bargain_header_bg/bargain_header_bg4.jpg';
					that.backHead = 'attachimage/change/bargain_tip/bargain_tip4.png';
					that.posterbackgd = '../../../static/images/bargain_post4.png'
					break;
				case 'theme5':
					that.backBg = 'attachimage/change/bargain_header_bg/bargain_header_bg5.jpg';
					that.backHead = 'attachimage/change/bargain_tip/bargain_tip5.png';
