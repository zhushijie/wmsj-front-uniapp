<template>
	...
	<view class='page' :data-theme="theme">
				...
				<view class="service ">
					<view class="service_title ">
						<view class="left_con skeleton-rect">
							<image src="../../static/img/wmsj/pindao.gif" style="" lazy-load></image>
							<view class="Stitle">频道</view>
							<view style="color: red;margin-left: 20rpx;margin-left: 9px;display: inline;line-height: 70rpx">
								{{zhiyuanzheNum}}
							</view>
							<view style="color: #555555;margin-left: 20rpx;margin-left: 9px;display: inline;line-height: 70rpx">
								位志愿者
							</view>
						</view>
						<navigator url="/pages/users/user_sgin/index" style="display: inline;text-align: right;" >
							<view class="right_con skeleton-rect button" >
								每日签到
							</view>
						</navigator>
					</view>
		...
		<view style="margin-top: 20rpx;border-top: 10px solid #f5f5f5;">
			...
			<view class="fengcai_title ">
				<view class="left_con skeleton-rect">
					<image src="../../static/tabBar/huodongfengcai.png" style="" lazy-load></image>
					<view class="title">活动风采</view>
				</view>
				<navigator  class='item skeleton-rect' url='/pages/usersWmsj/huodong/fengcaiList' hover-class='none'>
