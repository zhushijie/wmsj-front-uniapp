		...
		<div class="whiteBg" v-if="formItem === 1">
			...
			<div class="list" v-if="current !== 0 || appLoginStatus || appleLoginStatus">
				...
				<div class="item">
					<div class="acea-row row-middle">
						<image src="/static/images/code_2.png" style="width: 28rpx; height: 32rpx;"></image>
						<input type="password" class="texts" placeholder="设置密码6-8位字母加数字" maxlength="18" v-model="password" required />
					</div>
				</div>
			...
			<!-- #ifndef APP-PLUS -->
			<div class="tips">
				<div v-if="current==0" @click="current = 1">账号注册/找回密码</div>
			...
			<view class="appLogin" v-if="!appLoginStatus && !appleLoginStatus">
				...
				<view class="btn-wrapper">
					<view class="btn wx" @click="wxLogin" style="display: none;">
					...
					<view class="btn apple-btn" @click="appleLogin" v-if="appleShow"  style="display: none;">
